...
import com.td.server.filter.JwtAuthenticationTokenFilter;
import com.td.server.handler.security.AuthenticationFailHandlerImpl;
import com.td.server.handler.security.LogoutSuccessHandlerImpl;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/login", "/register", "/captchaImage", "/callback/**", "/forget", "/forget/**").anonymous()
                //登录后也可以访问
